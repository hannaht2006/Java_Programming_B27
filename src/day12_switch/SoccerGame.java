...
print: the end of the same is approaching
    ...
    public static void main(String[] args) {
        ...
        if(minutes>0 && minutes<=90) {  // valid time
            ...
            System.out.println("game cannot be longer than 90");
            }// System.out.println(minutes<0 ? "minutes cannot be negative" : "game cannot be longer than 90");
