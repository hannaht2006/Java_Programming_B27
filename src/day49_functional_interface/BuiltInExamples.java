...
public class BuiltInExamples {
    ...
    public static Predicate<Integer> lessThan5 = p -> p < 5;//BuiltInExample.lessThan5.test()
    ...
    public static void main(String[] args) {
        ...
        List<Integer> nums = new ArrayList<>(Arrays.asList(1, 5, 21, 6, 12, 4, 15, 1, 2, 5, 1, 2, 4, 1, 4, 12, 32, 5,15,2));

        nums.removeIf(isPrime);
        System.out.println(nums);

        nums =  new ArrayList<>(Arrays.asList(1, 5, 21, 6, 12, 4, 15, 1, 2, 5, 1, 2, 4, 1, 4, 12, 32, 5,15,2));
        ...
        List<String> words = new ArrayList<>(Arrays.asList("java", "soft Skill", "house", "shed", "emoji", "fun"));
