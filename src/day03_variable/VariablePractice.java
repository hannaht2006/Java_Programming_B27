...
public class VariablePractice {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("age"); //this print the character age, not the variable that has a number value
        System.out.println("20"); // printing the character 2 and 0
        System.out.println(20); //printing the int 20
        //by default 20 is int type
        System.out.println(age + 1);// age value is 10, then it adds 10 + 1 and print 11
        //byte num = 200; 200 is too big for byte types
        short num = 200; //declared and assigned at the time same
