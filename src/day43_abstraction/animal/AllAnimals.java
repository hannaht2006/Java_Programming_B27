...
public class AllAnimals {
 ...
 class Cat extends Animal implements Friendly{// group Playable, Petable to Friendly
 ...
 class Dog extends Animal implements Friendly { //group Playable, Petable to Friendly
