...
public class Book {
    public static void main(String[] args) {
        ...
        for (int i = 0; i< chapters; i++){
            ...
            book [i] = input.nextLine().trim().split(" ");// reading a String from the console , then trimming the extra spaces in the biginning, and end; finally splitting the array by spaces, getting a String array with each word as a separate element. That String array is stored into a book 2D array
